...
lv_obj_t * ui_Panel3;
lv_obj_t * ui_EmailMessage;
lv_obj_t * ui_ActionPanel;
lv_obj_t * ui_ActionLabel;
lv_obj_t * ui_ActionValue;
lv_obj_t * ui_ActionImage;
lv_obj_t * ui_SentimentPanel;
lv_obj_t * ui_SentimentLabel;
lv_obj_t * ui_SentimentValue;
lv_obj_t * ui_SentimentImage;
lv_obj_t * ui_PriorityPanel;
lv_obj_t * ui_PriorityLabel;
lv_obj_t * ui_PriorityValue;
lv_obj_t * ui_PriorityImage;
...
void ui_event_BackButton(lv_event_t * e)
{
    ...
    lv_obj_t * target = lv_event_get_target(e);
    if(event_code == LV_EVENT_CLICKED) {
        _ui_screen_change(&ui_Chat, LV_SCR_LOAD_ANIM_MOVE_RIGHT, 500, 0, &ui_Chat_screen_init);
    }
}
void ui_event_Email(lv_event_t * e)
{
